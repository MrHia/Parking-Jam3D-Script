...
public class Point_1 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Physics.Raycast(ray, out hit))
        {
            ...
            if (hit.collider.tag == "CarHorizontal-left" || hit.collider.CompareTag("CarHorizontal-right") || hit.collider.tag == "CarVertical-top" || hit.collider.tag == "CarVertical-bottom")
            {
